...
static struct neighbour *neigh_alloc(struct neigh_table *tbl, struct net_device *dev)
{
	...
	n->nud_state  = NUD_NONE; 	//Init State Of a Entry is NONE
	n->output	  = neigh_blackhole; //Default Output is discard.
 ...
 * State Machine for INTIMTER state
 * */
...
int __neigh_event_send(struct neighbour *neigh, struct sk_buff *skb)
{
	...
	//INCOMPLETE表示该表项是我们主动创建的，我们想向该邻居发送流量,但是对该邻居的双向可达性检测任然没有完成
